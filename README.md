...
O projeto em questão é um tocador de som que foi desenvolvido com javascript puro. O objetivo foi a prática das condições e lógicas de programação usando o javascript.
