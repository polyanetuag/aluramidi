...
O projeto é um **tocador de som** que foi desenvolvido com javascript puro. O objetivo foi praticar as condições e lógicas de programação usando somente essa linguagem.
...
- [DevTools  do navegador](https://developer.mozilla.org/en-US/docs/Learn_web_development/Howto/Tools_and_setup/What_are_browser_developer_tools) (práticas e testes)
